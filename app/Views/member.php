    ...
    <div class="row" id="basic-table">
        <div class="col-12 col-md-10">
            <div class="card">
                ...
                <button class="btn btn-primary" id="btnTambahMember" onclick="loadTambahMemberForm()">
                    <i class="fe fe-plus"></i> Tambah Member
                </button>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-info" onclick="loadEditMemberForm(<?= $key->id_member ?>)">
                                                <i class="now-ui-icons ui-1_check"></i> Edit
                                            </button>

                                            <a href="<?= base_url('home/hapus_member/' . $key->id_member) ?>">
